      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-2xl">
          <div className="bg-primary/10 flex items-center justify-center rounded-full backdrop-blur-md size-28">
            ...
            >
              <Play
                className="size-8 text-foreground fill-foreground group-hover:scale-105 scale-100 transition-transform duration-200 ease-out"
                style={{
                  filter:
      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 text-foreground text-xl bg-background/50 ring-1 backdrop-blur-md rounded-full p-2">
                <XIcon className="size-5" />
              </motion.button>
              <div className="size-full border-2 border-foreground rounded-2xl overflow-hidden isolate z-[1] relative">
                <iframe
                  src={videoSrc}
